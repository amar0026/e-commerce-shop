...
const PRODUCTS: GarmentProduct[] = [
  { id:'1', title:'Cotton Blend Co-ord Set',    brand:'Aurelia',     price:1299, originalPrice:1899, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1771325461/pngtree-trendy-summer-party-dress-model-girl-in-fashionable-attire-png-image_13211648_ys2ype.png', rating:4.5, reviewCount:'128', status:'New',        category:'Women',   description:'', fabric:'100% Cotton',  sizes:['XS','S','M','L','XL'],    badge:'New Arrival', badgeColor:'#16a34a', discount:32 },
  { id:'2', title:'Embroidered Anarkali Kurta', brand:'Biba',        price:2150, originalPrice:3200, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773296338/AmericanSilkPinkZariEmbroideredAnarkaliSuitPantWithDupatta_2_fzwckx.webp',                             rating:4,   reviewCount:'75',  status:'Bestseller', category:'Ethnic',  description:'', fabric:'Georgette',    sizes:['S','M','L','XL','XXL'],   badge:'Sale',        badgeColor:'#f97316', discount:33 },
  { id:'3', title:'Slim Fit Stretch Chinos',    brand:'FabIndia',    price:899,  originalPrice:1299, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773295573/Untitleddesign_98_r0vlhs.webp',                                                                       rating:4.5, reviewCount:'99',  status:'Bestseller', category:'Men',     description:'', fabric:'Cotton Blend', sizes:['30','32','34','36','38'], badge:'Bestseller',  badgeColor:'#111111', discount:31 },
  { id:'4', title:'Tropical Rayon Camp Shirt',  brand:'Manyavar',    price:749,  originalPrice:1100, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773296337/gemini-generated-image-hisdushisdushisd-1-500x500_z8jlod.webp',                                       rating:4.5, reviewCount:'214', status:'Trending',   category:'Men',     description:'', fabric:'Rayon',        sizes:['S','M','L','XL'],         badge:'Trending',    badgeColor:'#ea580c', discount:32 },
  { id:'5', title:'Kids Dungaree Playsuit',     brand:'H&M Kids',    price:599,  originalPrice:899,  image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773296148/images_26_wxn2do.jpg',                                                                                rating:4.8, reviewCount:'61',  status:'New',        category:'Kids',    description:'', fabric:'Denim Cotton', sizes:['2Y','4Y','6Y','8Y'],      badge:'New Arrival', badgeColor:'#16a34a', discount:33 },
  { id:'6', title:'Palazzo Sharara Set',        brand:'W for Woman', price:1799, originalPrice:2499, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773296149/gulmohar-cotton-hand-block-sharara-set-8853992_atc3e2.webp',                                          rating:4.3, reviewCount:'88',  status:'Bestseller', category:'Ethnic',  description:'', fabric:'Silk Blend',   sizes:['S','M','L','XL'],         badge:'Sale',        badgeColor:'#f97316', discount:28 },
  { id:'7', title:'Flared Denim Jeans',         brand:'Levis',       price:1499, originalPrice:2299, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773295972/images_24_dv4pnt.jpg',                                                                                rating:4.6, reviewCount:'302', status:'Trending',   category:'Women',   description:'', fabric:'98% Denim',    sizes:['26','28','30','32'],       badge:'Trending',    badgeColor:'#ea580c', discount:35 },
  { id:'8', title:'Bandhgala Nehru Jacket',     brand:'Manyavar',    price:3299, originalPrice:4999, image:'https://res.cloudinary.com/dquki4xol/image/upload/v1773295573/4_2ab5d4e8-2cc9-4134-83a2-e8a061395274_w6xpfq.webp',                                                  rating:4.7, reviewCount:'47',  status:'New',        category:'Western', description:'', fabric:'Art Silk',     sizes:['S','M','L','XL','XXL'],   badge:'New Arrival', badgeColor:'#16a34a', discount:34 },
];
