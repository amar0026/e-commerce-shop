...
const PRODUCTS: GarmentProduct[] = [
  ...
  { id:'5', title:'Kids Dungaree Playsuit',     brand:'H&M Kids',    price:599,  originalPrice:899,  image:'https://res.cloudinary.com/dquki4xol/image/upload/v1776147005/WhatsApp_Image_2026-04-14_at_11.28.22_AM_wj9iz9.jpg',  rating:4.8, reviewCount:'61',  status:'New',category:'Kids',    description:'', fabric:'Denim Cotton', sizes:['2Y','4Y','6Y','8Y'],      badge:'New Arrival', badgeColor:'#16a34a', discount:33 },
